...
class LoginController(QWidget):
    ...
    def __init__(self, window_controller):
        ...
        self.ui.pushButton_newAdmin.clicked.connect(self.signUp)
    ...
    def login(self):
        ...
        if admin_service is not None and bcrypt.checkpw(password.encode('utf-8'), admin_service.get_pass()) and username == admin_service.username:
            print("It Matches!")            
            self.window.close() 
