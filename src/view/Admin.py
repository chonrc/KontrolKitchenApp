...
"padding: 5px 5px;")
    ...
    def display_clients(self, client_list):
        clients_layout = QtWidgets.QVBoxLayout(self.frame_clients)

        header_layout = QtWidgets.QHBoxLayout()
        label_name = QtWidgets.QLabel("Client Name")
        label_id = QtWidgets.QLabel("Client ID")
        ...
        header_layout.addWidget(label_name)
        header_layout.addWidget(label_id)

        clients_layout.addLayout(header_layout)

        for client_info in client_list:
                client_layout = QtWidgets.QHBoxLayout()

                label_name = QtWidgets.QLabel(client_info[0])  # Access the Username from the tuple
                label_id = QtWidgets.QLabel(str(client_info[1]))  # Access the ClientID from the tuple

                client_layout.addWidget(label_name)
                client_layout.addWidget(label_id)

                clients_layout.addLayout(client_layout)

        self.frame_clients.setLayout(clients_layout)